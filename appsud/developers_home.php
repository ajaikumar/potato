...
<div class="container">
       ...
       <div id="ratings" class="navbar span12">
		  <ul class="nav">
			 ...
			 <li class="divider-vertical"><a href="#">Blog</a></li>
			 <li class="divider-vertical"><a href="#">Groups</a></li>
	  ...
	  <!-- Asynchronous Google Analytics snippet. Change UA-XXXXX-X to be your site's ID.
         ...
         <div class="useropt">
           ...
           <div class="container">
                    ...
                    You have "<span></span>" notifications</div>
                    
                    <div id="messages">
                    You have "<span></span>" messages</div>
